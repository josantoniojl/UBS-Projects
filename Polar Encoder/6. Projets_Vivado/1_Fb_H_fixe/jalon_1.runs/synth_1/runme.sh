...
HD_PWD='C:/VIVADO_TESTS/jalon_1/jalon_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log polarEncoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source polarEncoder.tcl
