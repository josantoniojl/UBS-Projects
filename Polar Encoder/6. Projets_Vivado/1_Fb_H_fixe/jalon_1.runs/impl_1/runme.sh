...
HD_PWD='C:/VIVADO_TESTS/jalon_1/jalon_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log polarEncoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source polarEncoder.tcl -notrace
